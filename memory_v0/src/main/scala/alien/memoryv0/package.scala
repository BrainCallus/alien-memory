...
import alien.memoryv0.handle.MemoryHandle.MemoryHandleSyntax
import alien.memoryv0.layout.{BoundedSequence, DynamicStruct, DynamicUnion}
import alien.memoryv0.typelevel.nat.*
import alien.memoryv0.typelevel.pow2.{Pow2, Pow2Constants}
import alien.memoryv0.layout.{DynamicStruct, DynamicUnion}
import alien.memoryv0.typelevel.nat.NatConstants
import alien.memoryv0.typelevel.pow2.{Pow2, Pow2Constants}

import scala.language.implicitConversions

package object memoryv0
  ...
  implicit final class SingletonStringOps[S <: String & Singleton](
    ...
    def :=[L <: Layout](layout: L): S := L = memoryv0.layout.:=(layout, s)
