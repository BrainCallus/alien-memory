...
def memoryHandle =
  s"""package alien.memoryv0.handle

import alien.memoryv0.{Global, Layout, Memory, Region}
...
for (i <- 0 to 9) {
  writeToFile(
    s"src/main/scala/alien/memoryv0/handle/MemoryPtr$i.generated.scala",
    ops_i(i),
  )
}
writeToFile(
  s"src/main/scala/alien/memoryv0/handle/MemoryHandle.generated.scala",
  memoryHandle,
)