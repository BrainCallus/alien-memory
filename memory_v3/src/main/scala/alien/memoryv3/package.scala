...
import alien.memoryv3.handle.MemoryHandle.MemoryHandleSyntax
import alien.memoryv3.layout.{BoundedSequence, DynamicStruct, DynamicUnion}
import alien.memoryv3.typelevel.nat.NatConstants
import alien.memoryv3.typelevel.pow2.{Pow2, Pow2Constants}

import scala.language.implicitConversions

package object memoryv3
  ...
  implicit final class SingletonStringOps[S <: String & Singleton](
    ...
    def :=[L <: Layout](layout: L): S := L = memoryv3.layout.:=(layout, s)
